...
class EmailSender:
    ...
    def send_team_registration_email(to_email: str, team_id: str, team_name: str, division: str):
        ...
        message.set_content(
            ...
            f"Division: {division}\n\n"
            f"Please make sure you have your team token handy and check the team information page for updates."
        )
    ...
    def send_team_payment_email(to_email: str, team_id: str, transaction_ids: list[str]):
        ...
        message.set_content(
            ...
            f"If you have any questions, please contact support with the transaction ID(s).\n\n"
        )
